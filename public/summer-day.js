(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = ".gestplant-summer{margin:12px 0;padding:13px 14px;border:1px solid #d8e6de;border-left:4px solid #134838;border-radius:4px;background:#f4f8f5;color:#123b30;font-family:inherit}.gestplant-summer__label{display:block;font-size:11px;font-weight:900;letter-spacing:.14em;text-transform:uppercase}.gestplant-summer__price{display:flex;align-items:baseline;gap:9px;margin-top:6px}.gestplant-summer__price strong{font-size:24px;line-height:1}.gestplant-summer__price del{font-size:13px;opacity:.65}.gestplant-summer__ends{display:block;margin-top:7px;font-size:11px;opacity:.8}.gestplant-summer-badge{position:absolute;z-index:3;top:9px;left:9px;padding:6px 8px;border-radius:3px;background:#123f32;color:#fff;font:800 10px/1.1 inherit;letter-spacing:.08em;text-transform:uppercase;pointer-events:none}.gestplant-summer-card{position:relative}.gestplant-summer-pdp-active .product__price-and-badge{display:block!important;width:100%!important}.gestplant-summer-pdp-active .product__price-and-badge>.product__price,.gestplant-summer-pdp-active .product__newsletter-offer{display:none!important}.gestplant-summer-pdp-active .product__price-and-badge>.gestplant-summer{width:100%!important;max-width:none!important;margin:12px 0!important}.gestplant-summer[hidden],.gestplant-summer-badge[hidden]{display:none!important}";
